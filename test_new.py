...
if os.path.exists("val_results_test"):
    shutil.rmtree("val_results_test")
os.makedirs("val_results_test")


if os.path.exists("val_results_test/img_res"):
    shutil.rmtree("val_results_test/img_res")
os.makedirs("val_results_test/img_res")


if os.path.exists("val_results_test/pcd"):
    shutil.rmtree("val_results_test/pcd")
os.makedirs("val_results_test/pcd")
...
def eval_val(model, pts_pth, lab_pth, num_classes, epoch, save_vis=False):
            ...
            for ab in range(len(p_3d)):
                ...
                if save_vis :
                    if random.random() < 1.1:
                        ...
                        plt.imsave(
                            f"val_results_test/img_res/Sample_{save_count}_pred.png", p_2d_img, cmap='gray')
                        plt.imsave(
                            f"val_results_test/img_res/Sample_{save_count}_gt.png", l_2d_img, cmap='gray')
                        plt.imsave(
                            f"val_results_test/img_res/Sample_{save_count}_depth.png", depth_2d_img, cmap='gray')
                        plt.imsave(
                            f"val_results_test/img_res/Sample_{save_count}_reflectivity.png", r_2d_img, cmap='gray')
                        ...
                        o3d.io.write_point_cloud(
                            f"val_results_test/pcd/Sample_{save_count}_pred.pcd", pcd_pred)
                        o3d.io.write_point_cloud(
                            f"val_results_test/pcd/Sample_{save_count}_gt.pcd", pcd_gt)
    ...
    with open(f"val_results_test/vallog_epoch_{epoch}.txt", "w") as f:
        f.write("---------------------------------------------------------\n")
